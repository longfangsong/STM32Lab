...
void LCD_Fast_DrawPoint(rt_uint16_t x, rt_uint16_t y,
                        rt_uint16_t color);              //快速画点
...
void LCD_DrawLine(rt_uint16_t x1, rt_uint16_t y1, rt_uint16_t x2,
                  rt_uint16_t y2); //画线
void LCD_DrawRectangle(rt_uint16_t x1, rt_uint16_t y1, rt_uint16_t x2,
                       rt_uint16_t y2); //画矩形
void LCD_Fill(rt_uint16_t sx, rt_uint16_t sy, rt_uint16_t ex, rt_uint16_t ey,
              rt_uint16_t color); //填充单色
void LCD_Color_Fill(rt_uint16_t sx, rt_uint16_t sy, rt_uint16_t ex,
                    rt_uint16_t ey,
                    rt_uint16_t *color); //填充指定颜色
void LCD_ShowChar(rt_uint16_t x, rt_uint16_t y, rt_uint8_t num, rt_uint8_t size,
                  rt_uint8_t mode); //显示一个字符
void LCD_ShowNum(rt_uint16_t x, rt_uint16_t y, rt_uint32_t num, rt_uint8_t len,
                 rt_uint8_t size); //显示一个数字
void LCD_ShowxNum(rt_uint16_t x, rt_uint16_t y, rt_uint32_t num, rt_uint8_t len,
                  rt_uint8_t size,
                  rt_uint8_t mode); //显示 数字
void LCD_ShowString(rt_uint16_t x, rt_uint16_t y, rt_uint16_t width,
                    rt_uint16_t height, rt_uint8_t size,
